          ...
          <Container maxWidth={false} style={{padding:0}}>
            {cubebox ?
              <m.div variants={varFade().inUp}>
                <m.div className="stage size-2x2 position-center float10s">
                  <m.div className="cube cube-size-2x2x2 info">
                    <img className="front" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/138980/female.png" />
                    <img className="side" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/138980/male.png" />
                  </m.div>
                  <m.div className="shadow shadow-size-2x2"></m.div>
                </m.div>
                <m.div className="stage size-1x1 position-left float5s">
                  <m.div className="cube cube-size-1x1x1 codepen"></m.div>
                  <m.div className="shadow shadow-size-1x1"></m.div>
                </m.div>
                <m.div className="stage size-1x1 position-right float7s">
                  <m.div className="cube cube-size-1x1x1 codepen"></m.div>
                  <m.div className="shadow shadow-size-1x1"></m.div>
                </m.div>
